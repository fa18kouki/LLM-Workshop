"""
演習C1: 並列処理で記事を複数観点から評価しよう

【目標】
- asyncio.gather を使った非同期並列処理を学ぶ
- 複数の評価軸で同時にLLMを呼び出す

【実行方法】
uv run python practice/genai_ver/c1.py

【ヒント】
- client.aio.models.generate_content で非同期呼び出し
...
async def evaluate_article(article: str) -> ArticleEvaluationResult:
    """記事を4つの評価軸で並列評価"""
    # ========================================
    # TODO: asyncio.gather を使って4つの評価を並列実行
    # ヒント:
