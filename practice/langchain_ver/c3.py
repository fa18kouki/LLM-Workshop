...
【実行方法】
uv run python practice/langchain_ver/c3.py
...
def revision_loop(article: str, max_iterations: int = 3):
    """修正・評価ループ"""
    ...
    for iteration in range(1, max_iterations + 1):
        ...
        # ========================================
        # TODO: 評価を実行
        # ヒント: evaluation = evaluate_article(current_article)
        # ========================================
...
if __name__ == "__main__":
    ...
    # 修正・評価ループを実行
    revision_loop(article, max_iterations=3)
